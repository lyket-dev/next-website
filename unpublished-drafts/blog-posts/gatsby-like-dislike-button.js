		...
		<>
			<Head>
				...
				<meta
					...
					content="Lyket lets you add like/dislike buttons, designed to support GDPR compliance, to any Gatsby project in a matter of seconds"
					name="description"
				/>
			</Head>
			<div className="page">
				...
				<section className="page__section">
					<div className="markdown">
						<p>
							...
							quickly implement like/dislike buttons on Gatsby. From the moment

			...
			<section className="page__section">
				<div className="markdown">
					...
					<ul>
						...
						<li>
							it is processed by one of our subprocessors listed below, strictly
					...
					<p>
						...
						cache — is hosted in the EU (Ireland, eu-west-1 region). Hashed IPs,
						account data, and vote/button data processed for the service do not
						leave the EEA.
					</p>
					<p>
						A couple of subprocessors we use for billing and email are based in
						the United States. Where personal data is transferred to them, we
						rely on the following legal mechanisms:
					</p>
					<ul>
						<li>
							...
							billing information of paying Lyket customers, not website visitor
							data.
						</li>
						<li>
					...
					<h4>Subprocessors</h4>
					<p>
						We use the following subprocessors to provide the Lyket service:
					</p>
					...
					<p>
						We will update this table whenever we add or remove a subprocessor.
						If you would like to be notified of changes, please contact us.
					</p>

...
import {
  ...
  ButtonIdRequiredProp,
  NamespaceOptionalProp,
  HideCounterOptionalProp,
} from "components/CommonButtonProps";
import { QuickReactDocsMenu } from "components/QuickDocsMenu";
import Code from "components/Code";
import Head from "next/head";
import Link from "next/link";
import { LikeButton, ClapButton, Provider } from "@lyket/react";
...
export default function Docs() {
  return (
    <>
      <Head>
        <title>
          Applause Button React - Add buttons to your React projects!
        </title>
        <meta
          content="Lyket is the ultimate tool to instantly add applause buttons to any React project!"
          name="description"
        />
      </Head>
      <div className="page">
